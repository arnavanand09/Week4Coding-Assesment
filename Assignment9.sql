...
BEGIN
    ...
    BEGIN
        ...
        PRINT 'Record for EmployeeID ' + CAST(@EmployeeID AS VARCHAR) + ' has been DELETED successfully.'; -- CAST to VARCHAR
    END
    ELSE
    BEGIN
        PRINT 'No record found for EmployeeID ' + CAST(@EmployeeID AS VARCHAR) + '. Deletion failed.'; -- CAST to VARCHAR
    END
END;
GO
